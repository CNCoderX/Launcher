...
//        mMaxGap = a.getDimensionPixelSize(R.styleable.CellLayout_maxGap, 0);
        mCountX = a.getInteger(R.styleable.CellLayout_cellCountX, 4);
        mCountY = a.getInteger(R.styleable.CellLayout_cellCountY, 4);
...
//
    public void enableHardwareLayers() {
        setLayerType(LAYER_TYPE_HARDWARE, sPaint);
    }

    public void disableHardwareLayers() {
        setLayerType(LAYER_TYPE_NONE, sPaint);
    }
...
//        child.setScaleY(getChildrenScale());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mWidthGap > 0) {
            mCellWidth = (hSpace - mWidthGap * numWidthGaps) / mCountX;
        } else {
            mCellWidth = hSpace / mCountX;
        }
        if (mHeightGap > 0) {
            mCellHeight = (vSpace - mHeightGap * numHeightGaps) / mCountY;
        } else {
...
//        setMeasuredDimension(newWidth, newHeight);
    ...
    public void measureChild(View child) {
        ...
        lp.setup(cellWidth, cellHeight, mWidthGap, mHeightGap, isRtl, mCountX);
